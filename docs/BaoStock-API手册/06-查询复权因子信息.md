...
通过API接口获取复权因子信息数据。示例数据：[下载](assets/adjust_factor_data.xlsx)

BaoStock提供的是**涨跌幅复权算法**复权因子，具体介绍见： [媒体文件:BaoStock复权因子简介.pdf](assets/BaoStockAdjustFactorIntro.pdf "BaoStock复权因子简介.pdf")。
...
上一节：[查询除权除息信息](05-查询除权除息信息.md)

返回：[手册目录](README.md)

下一节：[查询季频财务数据信息](07-查询季频财务数据信息.md)
